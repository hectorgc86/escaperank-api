...
var dbConnectMySql = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_1 = _a.sent();
                console.log("Error de Conexión con base de datos", e_1);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.dbConnectMySql = dbConnectMySql;
